...
public class selectsql {
	...
	public static  connmysql connmysql=new connmysql();
	/*
	...
	public int InsertBusiness(String category,String name,String ms,String img){
		...
		//灏嗘坊鍔犲悗鐨勭粨鏋滈噸鏂版帓搴忔斁鍏b_temp琛ㄤ腑銆�?			//String sql2="DROP TABLE tb_temp; SELECT IDENTITY (smallint, 1, 1) AS id, name, img, ms, category, submittime INTO tb_temp FROM tb_business ORDER BY id";
			i=connmysql.executeUpdate(sql);
			//System.out.println("test1"+connmysql.executeUpdate(sql2));
		}catch(Exception e){
			e.printStackTrace();
		}
		connmysql.close();
	...
	public int DelBusiness(String id){
		...
		try{
			...
			//灏嗗垹闄ゅ悗鐨勭粨鏋滈噸鏂版帓搴忔斁鍏b_temp琛ㄤ腑銆�?			//String sql2="DROP TABLE tb_temp; SELECT IDENTITY (smallint, 1, 1) AS id, name, img, ms, category, submittime INTO tb_temp FROM tb_business ORDER BY id";
			//System.out.println("test2"+connmysql.executeUpdate(sql2));
			i=connmysql.executeUpdate(sql);
		}catch(Exception e){
			e.printStackTrace();
		}
